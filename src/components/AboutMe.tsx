      ...
      <section className="about-me relative mt-16 " id="about-me" ref={ref}>
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-32 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          <article className="pl-60 max-lg:p-0">
            <img src={me} alt={me} style={{width: '400px'}}/>
          </article>
          <Swiper
            spaceBetween={100}
            centeredSlides={true}
          ...
          >
            {paragraphs.map((paragraph, index) => (
              <SwiperSlide
                className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-20 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] hover:border-orange duration-500 transition-all text-left max-lg:p-10 cursor-grab"
                key={index}
              >
                <div className="flex flex-row justify-start items-center max-lg:flex-col max-lg:justify-center max-lg:text-center ">
                  <div>
                    <img
                      src={paragraph.icon}
                      alt={paragraph.icon}
                  ...
                  <a className="autoplay-progress absolute right-10 top-40 z-10 flex items-center justify-center font-bold text-orange text-3xl">
                      {paragraph.subtitle}
                  </a>
