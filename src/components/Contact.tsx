...
import { contactData, toastMessages, profile } from "../assets/lib/data.tsx";
...
const Contact: React.FC = () => {
  const service_ID = 'service_j7ixzmm';
  const template_id = "template_lgermoi";
  const public_key = "Rm2oes9Qo8xYUFwaM";
